...
class SignUpController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    let alreadyHaveAccountButton: UIButton = {
        ...
        attributedTitle.append(NSAttributedString(string: "Sign In", attributes: [NSAttributedString.Key.foregroundColor: UIColor.rgb(17, 154, 237), NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 14)]))
